...
18. 不再使用spring boot自带的数据源，改为使用alibaba druid数据源管理数据库连接。
...
![输入图片说明](https://images.gitee.com/uploads/images/2019/0624/082702_333484cb_1110335.png "QQ截图20190624082634.png")
